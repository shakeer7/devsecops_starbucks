            ...
            <div className='fixed bottom-0 flex justify-between w-full bg-white sm:hidden z-50'>
                ...
                <div className='flex items-center flex-col p-4 bg-white w-full'>
                    <Link to="/pay" className="text-xl">
                        <BsCreditCard2Front className={location === "/pay" ? "text-green-800" : "text-green-500"} />
                    </Link>
                    <p className='text-xs'>Order</p>
                </div>
                ...
                <div className='flex items-center flex-col p-4 bg-white w-full'>
                    <Link to="/pay" className="text-xl">
                        <BsCreditCard2Front
                            className={location === "/pay" ? "text-green-800" : "text-green-500"}
                        />
                    </Link>
                ...
                <div className='flex items-center flex-col p-4 bg-white w-full'>
                    <Link to="/store" className="text-xl">
                        <BsShop
                            className={location === "/store" ? "text-green-800" : "text-green-500"}
                        />
                    </Link>
